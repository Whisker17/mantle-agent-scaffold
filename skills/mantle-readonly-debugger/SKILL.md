...
description: Diagnose Mantle read-path failures before execution. Use when RPC calls fail, quotes revert, balances look inconsistent, or read-only tooling returns ambiguous errors that need structured root-cause triage.
---
