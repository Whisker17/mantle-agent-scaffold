...
description: Use when preparing Mantle transaction simulation handoffs to external backends, then translating returned state-diff, gas, and revert data into WYSIWYS explanations.
---
