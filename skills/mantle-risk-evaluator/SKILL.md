...
description: Enforce pre-execution risk checks for Mantle transaction intents. Use when preparing swaps, liquidity actions, approvals, or any state-changing operation that must pass slippage, liquidity, and address-safety gates before execution.
---
