...
This section explains the high-level model behind Mantle MCP up to v0.2.5.
...
Descriptions, schemas, and prompts are written to maximize correct tool routing by LLMs. v0.2.5 specifically strengthens this with scenario-scoped tool exposure and tighter E2E assertions.
