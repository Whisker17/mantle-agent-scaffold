...
This section explains the high-level model behind Mantle MCP up to v0.2.9.
...
Descriptions, schemas, and prompts are written to maximize correct tool routing by LLMs. The v0.2.6-v0.2.9 line strengthens this with scenario-scoped tool exposure and tighter E2E assertions.
