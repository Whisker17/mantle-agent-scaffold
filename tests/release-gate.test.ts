...
import { evaluateReleaseGate, type ScenarioFailureType, type ScenarioRunRecord } from "../e2e/lib/runner.js";

function passedRecord(id: string): ScenarioRunRecord {
  return {
    scenarioId: id,
    status: "passed",
    attempts: 1,
...
function failedRecord(id: string, failureType: ScenarioFailureType): ScenarioRunRecord {
  return {
    scenarioId: id,
    status: "failed",
    attempts: 1,
...
function skippedRecord(id: string): ScenarioRunRecord {
  return {
    scenarioId: id,
    status: "skipped",
    attempts: 0,
