...
export const tokenScenarios: AgentScenario[] = [
  {
  ...
  },
  {
    ...
    prompt:
      "Resolve the mETH token on Mantle and return the quick-reference result. Set require_token_list_match=false for this check.",
